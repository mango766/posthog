...
const PersonsDeletePropertyCreateSchema = PersonsDeletePropertyCreateParams.omit({ project_id: true }).extend(
    PersonsDeletePropertyCreateBody.shape
)

const personsDeletePropertyCreate = (): ToolBase<typeof PersonsDeletePropertyCreateSchema, unknown> => ({
    name: 'persons-delete-property-create',
    schema: PersonsDeletePropertyCreateSchema,
    handler: async (context: Context, params: z.infer<typeof PersonsDeletePropertyCreateSchema>) => {
        const projectId = await context.stateManager.getProjectId()
...
const PersonsUpdatePropertyCreateSchema = PersonsUpdatePropertyCreateParams.omit({ project_id: true }).extend(
    PersonsUpdatePropertyCreateBody.shape
)

const personsUpdatePropertyCreate = (): ToolBase<typeof PersonsUpdatePropertyCreateSchema, unknown> => ({
    name: 'persons-update-property-create',
    schema: PersonsUpdatePropertyCreateSchema,
    handler: async (context: Context, params: z.infer<typeof PersonsUpdatePropertyCreateSchema>) => {
        const projectId = await context.stateManager.getProjectId()
        const body: Record<string, unknown> = {}
...
const PersonsBulkDeleteCreateSchema = PersonsBulkDeleteCreateBody

const personsBulkDeleteCreate = (): ToolBase<typeof PersonsBulkDeleteCreateSchema, unknown> => ({
    name: 'persons-bulk-delete-create',
    schema: PersonsBulkDeleteCreateSchema,
    handler: async (context: Context, params: z.infer<typeof PersonsBulkDeleteCreateSchema>) => {
        const projectId = await context.stateManager.getProjectId()
        const body: Record<string, unknown> = {}
...
export const GENERATED_TOOLS: Record<string, () => ToolBase<ZodObjectAny>> = {
    ...
    'persons-delete-property-create': personsDeletePropertyCreate,
    'persons-update-property-create': personsUpdatePropertyCreate,
    'persons-bulk-delete-create': personsBulkDeleteCreate,
